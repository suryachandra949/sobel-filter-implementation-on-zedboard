...
wire sig_newsob_ap_start;
wire sig_newsob_ap_ready;
wire sig_newsob_ap_done;
wire sig_newsob_ap_idle;

wire sig_newsob_ap_rst_n;



newsob newsob_U(
    .ap_start(sig_newsob_ap_start),
    .ap_ready(sig_newsob_ap_ready),
    .ap_done(sig_newsob_ap_done),
    .ap_idle(sig_newsob_ap_idle),
    .ap_rst_n(sig_newsob_ap_rst_n),
    .ap_clk(aclk),
...
newsob_CONTROL_BUS_if #(
    .C_ADDR_WIDTH(C_S_AXI_CONTROL_BUS_ADDR_WIDTH),
    .C_DATA_WIDTH(C_S_AXI_CONTROL_BUS_DATA_WIDTH))
newsob_CONTROL_BUS_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_ap_start(sig_newsob_ap_start),
    .O_ap_ready(sig_newsob_ap_ready),
    .O_ap_done(sig_newsob_ap_done),
    .O_ap_idle(sig_newsob_ap_idle),
